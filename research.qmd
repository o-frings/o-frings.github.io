...
The thesis asks whether market-based instruments can deliver the forest ecosystem services society wants, in three parts. The first estimates demand, combining econometrics and machine learning in choice modelling to measure public willingness to pay and map preference heterogeneity. The second addresses supply-side integrity, with a risk-adjusted framework that prices additionality, permanence, and leakage into forest-carbon finance. The third turns to governance: whether people prefer markets or government regulation, and how public trust and perceived efficiency shape that choice. Together they link demand-side valuation to supply-side integrity, to judge when nature markets are a suitable policy tool.
